  ...
  export default {
    ...
    methods: {
      ...
      async updateUsername() {
        try {
          await this.$http.put(`/api/admin/users/${this.$store.state.username}`, { username: this.newUsername });
      ...
      async updatePassword() {
        try {
          await this.$http.put(`/api/admin/users/${this.$store.state.username}`, { password: this.newPassword });
